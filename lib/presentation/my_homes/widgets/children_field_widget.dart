  ...
  Widget build(BuildContext context) {
    return BlocConsumer<MyHomesFormBloc, MyHomesFormState>(
      ...
      builder: (context, state) {
        int maxChildren = context.watch<MyHomesFormBloc>().state.home.maxChildren;
              ...
              Row(
                ...
                children: [
                  CircleIconButtonWidget(
                    onPressed: () => context.read<MyHomesFormBloc>().add(const MyHomesFormEvent.childrenRemove(1)),
                  ...
                  Padding(
                    ...
                    child: SizedBox(width: 30, child: Text(maxChildren.toString(), textAlign: TextAlign.center, style: const TextStyle(fontSize: 20),)),
                  ),
                  CircleIconButtonWidget(
                    onPressed: () => context.read<MyHomesFormBloc>().add(const MyHomesFormEvent.childrenAdd(1)),
