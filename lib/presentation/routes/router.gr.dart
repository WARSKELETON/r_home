...
import '../../domain/homes/home.dart' as _i19;
import '../../domain/local_activities/local_activity.dart' as _i20;
...
import '../my_local_activities_form/category_selection_page.dart' as _i12;
import '../my_local_activities_form/my_local_activities_form.dart' as _i13;
import '../profile/profile_page.dart' as _i7;
import '../profile/send_tokens_page.dart' as _i15;
import '../profile/transaction_history_page.dart' as _i14;
import '../profile/wallet_page.dart' as _i10;
import '../sign_in/role_page.dart' as _i3;
import '../sign_in/sign_in_page.dart' as _i2;
import '../splash/splash_page.dart' as _i1;
import '../splash/test_page.dart' as _i16;

class MyRouter extends _i17.RootStackRouter {
  MyRouter([_i18.GlobalKey<_i18.NavigatorState>? navigatorKey])
      : super(navigatorKey);
  ...
  final Map<String, _i17.PageFactory> pagesMap = {
    ...
    CategorySelectionPageRoute.name: (routeData) {
      return _i17.MaterialPageX<dynamic>(
          routeData: routeData,
          child: const _i12.CategorySelectionPage(),
          fullscreenDialog: true);
    },
    MyLocalActivitiesFormRoute.name: (routeData) {
      ...
      return _i17.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i13.MyLocalActivitiesForm(
    ...
    TransactionHistoryPageRoute.name: (routeData) {
      ...
      return _i17.CustomPage<dynamic>(
          routeData: routeData,
          child: _i14.TransactionHistoryPage(
    ...
    SendTokensPageRoute.name: (routeData) {
      return _i17.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i15.SendTokensPage(),
          transitionsBuilder: _i17.TransitionsBuilders.slideLeft,
          durationInMilliseconds: 150,
          opaque: true,
          barrierDismissible: false);
  ...
  List<_i17.RouteConfig> get routes => [
        ...
        _i17.RouteConfig(SignInPageRoute.name, path: '/sign-in-page'),
        _i17.RouteConfig(RolePageRoute.name, path: '/role-page'),
        _i17.RouteConfig(HomePageRoute.name, path: '/home-page'),
        _i17.RouteConfig(MyHomesPageRoute.name, path: '/my-homes-page'),
        _i17.RouteConfig(MyHomesFormRoute.name, path: '/my-homes-form'),
        _i17.RouteConfig(ProfilePageRoute.name, path: '/profile-page'),
        _i17.RouteConfig(MyHomeDetailsPageRoute.name,
            path: '/my-home-details-page'),
        _i17.RouteConfig(MyLocalActivityDetailsPageRoute.name,
            path: '/my-local-activity-details-page'),
        _i17.RouteConfig(WalletPageRoute.name, path: '/wallet-page'),
        _i17.RouteConfig(MyLocalActivitiesPageRoute.name,
            path: '/my-local-activities-page'),
        _i17.RouteConfig(CategorySelectionPageRoute.name,
            path: '/category-selection-page'),
        _i17.RouteConfig(MyLocalActivitiesFormRoute.name,
            path: '/my-local-activities-form'),
        _i17.RouteConfig(TransactionHistoryPageRoute.name,
            path: '/transaction-history-page'),
        _i17.RouteConfig(SendTokensPageRoute.name, path: '/send-tokens-page'),
        _i17.RouteConfig(TestPageRoute.name, path: '/test-page')
      ];
}
...
/// generated route for
/// [_i3.RolePage]
class RolePageRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i5.MyHomesPage]
class MyHomesPageRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i6.MyHomesForm]
class MyHomesFormRoute extends _i17.PageRouteInfo<MyHomesFormRouteArgs> {
  MyHomesFormRoute({_i18.Key? key, _i19.Home? editedHome})
...
class MyHomeDetailsPageRoute
    extends _i17.PageRouteInfo<MyHomeDetailsPageRouteArgs> {
  MyHomeDetailsPageRoute({_i18.Key? key, required String homeUuid})
...
class MyLocalActivityDetailsPageRoute
    extends _i17.PageRouteInfo<MyLocalActivityDetailsPageRouteArgs> {
  MyLocalActivityDetailsPageRoute(
      {_i18.Key? key, required String localActivityUuid})
...
/// generated route for
/// [_i10.WalletPage]
class WalletPageRoute extends _i17.PageRouteInfo<void> {
...
class MyLocalActivitiesPageRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i12.CategorySelectionPage]
class CategorySelectionPageRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i13.MyLocalActivitiesForm]
class MyLocalActivitiesFormRoute
    extends _i17.PageRouteInfo<MyLocalActivitiesFormRouteArgs> {
  MyLocalActivitiesFormRoute(
      {_i18.Key? key, _i20.LocalActivity? editedActivity})
...
class MyLocalActivitiesFormRouteArgs {
  ...
  final _i20.LocalActivity? editedActivity;
...
/// generated route for
/// [_i14.TransactionHistoryPage]
class TransactionHistoryPageRoute
    extends _i17.PageRouteInfo<TransactionHistoryPageRouteArgs> {
  TransactionHistoryPageRoute({_i18.Key? key, required List<int> transactions})
...
/// generated route for
/// [_i15.SendTokensPage]
class SendTokensPageRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i16.TestPage]
class TestPageRoute extends _i17.PageRouteInfo<void> {
