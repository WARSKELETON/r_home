...
class MyRouter extends _i16.RootStackRouter {
  ...
  List<_i16.RouteConfig> get routes => [
        ...
        _i16.RouteConfig(MyHomeDetailsPageRoute.name,
            path: '/my-home-details-page'),
        _i16.RouteConfig(MyLocalActivityDetailsPageRoute.name,
...
class MyHomeDetailsPageRoute
    extends _i16.PageRouteInfo<MyHomeDetailsPageRouteArgs> {
  MyHomeDetailsPageRoute({_i17.Key? key, required String homeUuid})
...
class MyLocalActivityDetailsPageRoute
    extends _i16.PageRouteInfo<MyLocalActivityDetailsPageRouteArgs> {
  MyLocalActivityDetailsPageRoute(
      {_i17.Key? key, required String localActivityUuid})
