...
class RentalPetsField extends StatelessWidget {
  const RentalPetsField({Key? key}) : super(key: key);
              ...
              Row(
                ...
                children: [
                  CircleIconButtonWidget(
                    onPressed: () => context.read<RentAHomeBloc>().add(const RentAHomeEvent.petsRemove(1)),
                  ...
                  Padding(
                    ...
                    child: SizedBox(width: 30, child: Text(numPets.toString(), textAlign: TextAlign.center, style: const TextStyle(fontSize: 20),)),
                  ),
                  CircleIconButtonWidget(
                    onPressed: () => context.read<RentAHomeBloc>().add(const RentAHomeEvent.petsAdd(1)),
