...
abstract class $DomainUserCopyWith<$Res> {
  ...
  $Res call(
      {String id, String? email, String? name, String? photo, String role});
}
...
class _$_DomainUser implements _DomainUser {
  ...
  @override
  String toString() {
    return 'DomainUser(id: $id, email: $email, name: $name, photo: $photo, role: $role)';
  }
...
abstract class _DomainUser implements DomainUser {
  const factory _DomainUser(
      ...
      String? name,
      String? photo,
      required String role}) = _$_DomainUser;
